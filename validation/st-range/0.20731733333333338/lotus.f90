...
! -- Hyperparameters
  real, parameter    :: thicc=0.03*c
    real, parameter    :: A = 0.1*c, St_d = 0.20731733333333338, k_x=0., k_z=16.0, h_roughness=0.0
  real, parameter    :: coeffs(3) = [0.072, 0.1685, -0.0701] ! lowest power first
  real, parameter    :: k_coeff = 1/2.156, f = St_d/(2.*(sum(coeffs))*c)
!
! -- Dimensions
  integer            :: n(3), ndims=2
!
